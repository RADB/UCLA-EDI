...
if blnSecurity then
  if session("consent") = True then
	...
	strSql = "SELECT [name],url, description FROM [reports] WHERE IsTeacherReport = 1 AND EDIYear = " & EDIYear & " ORDER BY Sequence"
...
<body onload="StartClock24();">
	<!-- #include file="shared/page_header.asp" -->	
		<a class="reglinkMaroon" href="teacher.asp">Home</a>&nbsp;<font class="regTextBlack">></font>&nbsp;<font class="boldTextBlack">Reports and Resources</font>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="760">
					<tr>
						<td align="right" width="400">
							<font class="headerBlue">Reports and Resources</font>
						</td>
						<td align="right">							
