...
if blnSecurity then   
    ...
    if request.form("Decision") = "Agree" then     
        if session("consent")= "False"  then         
            ' update consent        
	        call open_adodb(conn, "UCLAEDI")
	        datetime = now 
	        strSql = "UPDATE [teacher] SET consentGiven = 'True', consentDate = '" & datetime & "' WHERE teacherid = '" & session("teacherID") & "'"		        
	        conn.execute strSql	    	   	    
	        call close_adodb(conn)	
	        session("consent") = True   
	        session("consentDate") = datetime
        end if 
...
<body onload="StartClock24();">
	<!-- #include file="shared/page_header.asp" -->	
		<font class="boldTextBlack">Teacher Consent</font>
		...
		<tr>
			<td>
				<table border="0" cellpadding="0" cellspacing="0" width="760">
					<tr>
						<td align="right" width="450">
							<font class="headerBlue">Teacher Consent</font>
						</td>
						<td align="right">							
				...
				<form name="Consent" method="POST" action="teacher_consent.asp">
				    ...
				    <table border="0" cellpadding="0" cellspacing="0" width="500" align="center">
					    ...
					    <tr>
					        <td>
                                ...
                                <p align="center" class="boldTextBlack">KINDERGARTEN TEACHER INFORMATION SHEET AND CONSENT FORM</p>                            
					    ...
					    <tr><td align="center"><input type="button" name="I Agree" value="I Agree" onclick="javascript:update_TeacherConsent('Agree');"/>&nbsp;&nbsp;<input type="button" name="I Do Not Agree" value="I Do Not Agree" onclick="javascript:window.location='default.asp?status=logout';"/></td></tr>
					    <tr><td><br/></td></tr>
				    </table>
				</form>
			</td>			
